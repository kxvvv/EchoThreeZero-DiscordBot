...
#         text = '''
# :outbox_tray: phobia: Зачем вы человека в космос кинули?
# :inbox_tray: Sqreen: я его там оставил
# :inbox_tray: Sqreen: ена входе
# :outbox_tray: phobia: И что?
# :inbox_tray: Sqreen: ну так он мима просто атк связал
# :outbox_tray: phobia: Это повод чтоб кидать человека в космос?
# :inbox_tray: Sqreen: я его на входе оставил
# :inbox_tray: Sqreen: не в космосе
# :outbox_tray: phobia: Ладно.
# '''
#         text2 = '''
# :outbox_tray: phobia: Зачем вы человека в космос кинули?
# :inbox_tray: Sqreen: я его там оставил
...
#     if ctx.channel.id == AHELP_ROOM:
#         if ctx.content != '!!!test':
#             embed = ctx.embeds
#             ctx = client.get_channel(AHELP_ROOM)
#             try:
#                 embed = embed[0]
#             except:
#                 return
...
# async def my_edit_message(before, after):
#     ctx = client.get_channel(AHELP_ROOM)

#     beforeEmbed = await ctx.fetch_message(before.id)
#     beforeEmbed = beforeEmbed.embeds
#     beforeEmbed = beforeEmbed[0]
#     print(beforeEmbed.description)

#     print('\n')
#     print('\n')
#     print('\n')

#     embed = await ctx.fetch_message(after.id)
#     embed = embed.embeds
#     embed = embed[0]
